...
cfssl gencert -initca vault_root_CA.json | /usr/local/bin/cfssljson -bare vault_root_CA
...
-config vault-int-client-cert.json vault-client-cert.json | /usr/local/bin/cfssljson -bare vault_cert
